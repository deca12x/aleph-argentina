...
import { baycDescription, baycTraitCategories, baycNfts } from '@/data/bayc';

export default function BaycPage() {
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <aside className="w-full md:w-80">
            <h1 className="collection-title text-4xl mb-4">BAYC</h1>
            <p className="text-white text-sm mb-6">{baycDescription}</p>

            <TraitsFilter
              traitCategories={baycTraitCategories}
