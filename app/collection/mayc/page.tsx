...
import { maycDescription, maycTraitCategories, maycNfts } from '@/data/mayc';

export default function MaycPage() {
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <aside className="w-full md:w-80">
            <h1 className="text-4xl mb-4 font-megazoid text-mayc-yellow">MAYC</h1>
            <p className="text-white text-sm mb-6">{maycDescription}</p>

            <TraitsFilter
              traitCategories={maycTraitCategories}
